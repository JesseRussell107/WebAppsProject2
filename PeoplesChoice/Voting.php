...
<div id="content">
    ...
    <form action="" method="post">
        ...
        <input type="submit" class="button" name="getballot" value="Go"/>
    </form>
    <div>
        <form id='ballot' method="post" action="submitBallot.php">
            ...
            if ($projNum == 0) {
                ...
                echo "<input class='button' type='submit' name='sendballot' value='Submit my Ballot'>";
                echo "<table>";
                echo "<tr>";
                echo "<th>Name</th>";
                echo "<th>First</th>";
            ...
            <div id='writeins'>
                ...
                <button id='addwritein' type='button' class="button" value='addwritein' onclick="addWritein();">Add a Write-In</button>
